...
import { config } from '../../../config';
     ...
     export default class EditExpert extends Component {
      ...
      componentDidMount(){
        ...
        axios.get(config+'/BoussolePro-backend/getExpertById.php?id='+this.props.match.params.id)
        .then(response=>{
          this.setState({
      ...
      onSubmit(e){
        ...
        axios.post(config+'/BoussolePro-backend/updateExpert.php?id='+this.props.match.params.id,EditExpert).then(res=>console.log(res.data));
