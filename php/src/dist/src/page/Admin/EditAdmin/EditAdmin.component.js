...
function EditAdmin() {
    return (
            ...
            <Col span={24}>
                ...
                <Alert
                message="Bienveneu sur page de modifier  Administrateur"
                description=" Pour Modifier les informations d'un Administrateur merci de modifier le formulaire suivant."
                      type="info"
                      showIcon
                      />
                      <b/> 
     ...
     <Button type="primary" required style={{margin:"10px"}}>Soumettre</Button>
