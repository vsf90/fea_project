...
import axios from 'axios';
     ...
     export default class EditAdmin extends Component {
      ...
      componentDidMount(){
        ...
        axios.get('http://localhost/BoussolePro-backend/getAdminById.php?id='+this.props.match.params.id)
        .then(response=>{
          this.setState({
      ...
      render() {
        console.log(this.state);
         ...
         <Col span={24}>
             ...
             <Alert
             message="Bienvenue sur la page modifier Admin"
             description=" Pour Modifier les informations d'un Administrateur merci de remplir le formulaire suivant."
                   type="info"
                   showIcon
                   />
                   <b/> 
