...
include 'connect.php';
 ...
 if(isset($postdata) && !empty($postdata))
 {
     ...
     $prenomAbonne=htmlspecialchars($request->prenomAbonne,ENT_QUOTES);
     $rangAbonne=htmlspecialchars($request->rangAbonne,ENT_QUOTES);
    ...
    // $date=$request->date;
     ...
     //store:
     $sql="UPDATE `sprintpro` SET `initiateur`='$initiateur',`prenom`='$prenom',`nom`='$nom',`avecQui`='$avecQui',`prenomAbonne`='$prenomAbonne',`rangAbonne`='$rangAbonne',`prenomExterieure`='$prenomExterieure',`raison`='$raison',`creneaux`='$creneaux' WHERE ID='{$id}' LIMIT 1";
