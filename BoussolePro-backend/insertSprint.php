...
$con = mysqli_connect("localhost", "root", "", "boussolepro");
 ...
 if(isset($postdata) && !empty($postdata))
 {
  ...
  echo $creneaux;
  $valider=0;
     $req="INSERT INTO sprintpro (`initiateur`, `prenom`, `nom`,`avecQui`, `prenomAbonne`, `rangAbonne`, `prenomExterieure`, `raison`, `creneaux`, `date`, `valider`) 
     VALUES ( '{$radio}', '{$prenom}', '{$nom}','{$avecqui}', '{$prenomabonné}','{$rang}','{$prenomexterieure}','{$raisonsprint}', '{$creneaux}', '{$date}', '{$valider}' )";
