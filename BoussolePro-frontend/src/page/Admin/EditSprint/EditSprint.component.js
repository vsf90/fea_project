...
import { config } from '../../../config';
     ...
     export default class EditSprint extends Component {
      ...
      componentDidMount(){
        ...
        axios.get(config+'/BoussolePro-backend/getSprintById.php?id='+this.props.match.params.id)
        .then(response=>{
          this.setState({
      ...
      onSubmit(e){
        ...
        axios.post(config+'/BoussolePro-backend/updateSprint.php?id='+this.props.match.params.id,EditSprint).then(res=>console.log(res.data));
